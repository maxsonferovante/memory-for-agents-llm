...
This skill must finish the curation flow in one pass: write the proposal if needed, promote it to the canonical target, and verify the result. Do not stop after drafting a proposal and do not ask the user whether promotion should happen.
