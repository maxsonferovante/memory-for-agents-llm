...
9. Mark the proposal `ready` when it passes validation so the Stop hook can promote it.
10. Link the relevant indexes and repo-local notes.
11. Record unresolved conflicts or follow-ups.
...
- Any ready proposal has been handed off to the promotion hook.
